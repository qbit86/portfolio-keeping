...
namespace Diversifolio
{
    internal static class Program
    {
        ...
        private static async Task Main()
        {
            ...
            await using SqliteConnection _ = await CreatePortfolioConnection(dirName, portfolioName)
                .ConfigureAwait(false);
        }

        private static async Task<SqliteConnection> CreatePortfolioConnection(
