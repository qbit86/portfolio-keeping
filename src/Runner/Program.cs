...
namespace Diversifolio
{
    internal static class Program
    {
        ...
        private static async Task Main()
        {
            ...
            var positions = positionByTicker.Values.OrderBy(it => it.Ticker, StringComparer.Ordinal).ToList();
            ...
            foreach (KeyValuePair<string, IReadOnlyList<Security>> kv in securitiesByMarket)
            {
