...
public static class Tickers
{
    ...
    private static (string, AssetClass, string)[] CreateTuples() => new[]
    {
        ...
        ("FXEM", AssetClass.Stock, Boards.Tqtf),
